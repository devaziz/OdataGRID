  ...
  tr: {
    translation: {
      ...
      "toolbar": {
        ...
        "topPlaceholder": "Top ($top)",
        "skipPlaceholder": "Skip ($skip)",
        "applyPaging": "Uygula",
        "getOdata": "Veri Al",
        "loginSap": "SAP Giriş",
        "totals": "Toplamlar",
        ...
        "topTooltip": "Opsiyonel: Döndürülecek maksimum kayıt sayısı",
        "skipTooltip": "Opsiyonel: Atlanacak kayıt sayısı",
        "applyPagingTooltip": "Top/Skip değerlerini uygula",
  ...
  en: {
    translation: {
      ...
      "toolbar": {
        ...
        "topTooltip": "Optional: maximum number of returned records",
        "skipTooltip": "Optional: number of records to skip",
        "applyPagingTooltip": "Apply top/skip values",
  ...
  de: {
    translation: {
      ...
      "toolbar": {
        ...
        "topTooltip": "Optional: maximale Anzahl zurückgegebener Datensätze",
        "skipTooltip": "Optional: Anzahl zu überspringender Datensätze",
        "applyPagingTooltip": "Top/Skip-Werte anwenden",
